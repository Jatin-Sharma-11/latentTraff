"""PEMS08 config — CLFMv2 Ablation: No Temporal Embeddings."""
import os, sys
...
from idea.CLFM.v2.ablations import CLFMv2_NoTemporalEmb
...
MODEL_ARCH = CLFMv2_NoTemporalEmb
MODEL_PARAM = {
    ...
    # temporal flags ignored by this ablation, but kept for completeness
    "if_T_i_D": False, "if_D_i_W": False,
    "time_of_day_size": 288, "day_of_week_size": 7,
}
NUM_EPOCHS = 50

CFG = EasyDict()
CFG.DESCRIPTION = 'CLFMv2 Ablation: No Temporal Embeddings on PEMS08'
CFG.GPU_NUM = 1
