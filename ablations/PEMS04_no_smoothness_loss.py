"""PEMS04 config — CLFMv2 Ablation: No Smoothness Loss."""
import os, sys
...
MODEL_PARAM = {
    "num_nodes": 307, "input_len": INPUT_LEN, "input_dim": 3,
...
CFG = EasyDict()
CFG.DESCRIPTION = 'CLFMv2 Ablation: No Smoothness Loss on PEMS04'
CFG.GPU_NUM = 1
