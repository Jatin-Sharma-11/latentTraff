"""PEMS04 config — CLFMv2 Ablation: No Graph Laplacian."""
import os, sys
...
from idea.CLFM.v2.ablations import CLFMv2_NoLaplacian
...
CFG = EasyDict()
CFG.DESCRIPTION = 'CLFMv2 Ablation: No Laplacian on PEMS04'
CFG.GPU_NUM = 1
