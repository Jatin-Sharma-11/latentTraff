"""PEMS04 config — CLFMv2 Ablation: No Neural PDE."""
import os, sys
...
from idea.CLFM.v2.ablations import CLFMv2_NoNeuralPDE
...
CFG = EasyDict()
CFG.DESCRIPTION = 'CLFMv2 Ablation: No Neural PDE on PEMS04'
CFG.GPU_NUM = 1
