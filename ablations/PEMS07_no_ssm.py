"""PEMS07 config — CLFMv2 Ablation: No SSM."""
import os, sys
...
from idea.CLFM.v2.ablations import CLFMv2_NoSSM
...
CFG = EasyDict()
CFG.DESCRIPTION = 'CLFMv2 Ablation: No SSM on PEMS07'
CFG.GPU_NUM = 1
